...
export async function POST(req: Request) {
  try {
    ...
    const stripeSignature = z
      .string()
      .parse(req.headers.get("Stripe-Signature"));
    ...
    switch (event.type) {
      case "customer.created":
        ...
        await supabaseWithServiceRoleForServer.from("stripe_customers").insert([
          {
      ...
      case "customer.subscription.created":
        const customerSubscriptionCreated = z
          .object({
            id: z.string(),
            status: z.enum([
              "incomplete",
      ...
      case "customer.subscription.deleted":
        const customerSubscriptionDeleted = z
          .object({
            id: z.string(),
          })
          .parse(event.data.object);
      ...
      case "customer.subscription.updated":
        const customerSubscriptionUpdated = z
          .object({
            id: z.string(),
        ...
        await supabaseWithServiceRoleForServer
          ...
          .update({
            ...
            canceled_at: customerSubscriptionUpdated.canceled_at
              ? new Date(
      ...
      case "invoice.payment_succeeded":
        const invoicePaymentSucceeded = z
          .object({
            status: z.string(),
            customer: z.string(),
            lines: z.object({
          ...
          .insert([
            {
              ...
              user_id:
                invoicePaymentSucceeded.subscription_details.metadata.user_id,
            },
          ])
          .throwOnError();
